...
export const COLLECTOR_HEADERS_WITH_CRITERIA = [...COLLECTOR_HEADERS,"Criteriu1","Criteriu2","Criteriu3","Criteriu4","Criteriu5"];
export const MASS_TEMPLATE_HEADERS = ["ParticipantName","ParticipantEmail","EvaluatorName","EvaluatorEmail","Relationship","Language","Criteriu1","Criteriu2","Criteriu3","Criteriu4","Criteriu5"];
...
export function parseSourceWorkbook(XLSX, data, sourceName) {
  const workbook = XLSX.read(data, { type: data instanceof ArrayBuffer ? "array" : "buffer", cellFormula: false, cellHTML: false });
